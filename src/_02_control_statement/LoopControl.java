...
public class LoopControl {
    ...
    public static void main(String[] args) {
        ...
        // 조건식을 먼저 검사한 후 루프 본문 실행
        // 조건식부터 거짓이므로 루프 본문이 한번도 실행 안됨
        ...
        // 루프 본문을 먼저 실행한 후 조건을 검사
        // do 블럭 무조건 먼저 한번 실행 후 조건식 비교하기 때문에 k가 한번 출력됨
        ...
        // - 오류 발생 가능성이 낮음 : 인덱스를 사용하지 않으니 인덱스 관련 오류를 줄일 수 있음 (ex. 인덱스가 범위를 벗어나는 오류 등)
        // - 순회 전용 : 순차적으로 접근할 때만 사용 가능
        // - 읽기 전용 : 반복문 안에서 컬렉션 구조를 변경할 수 없음
        // - 역방향 순회 불가 : 항상 처음부터 끝까지 순회
        // => 모든 요소에 대해 동일한 작업을 할 때 유리
        // => 인덱스가 필요하거나 특정 조건에서 순회를 중단해야 한다면 일반 for 문이나 while 문이 적합

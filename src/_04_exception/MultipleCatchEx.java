...
public class MultipleCatchEx {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // 문자열을 정수로 변환
            int number = Integer.parseInt(input); // => NumberFormatException 에러 발생 가능성

            // 입력받은 숫자를 나누기 시도
            int dividedResult = 100 / number; // => ArithmeticException
            ...
            System.out.println("[ERROR] 숫자 형식이 잘못 되었습니다: " + e.getMessage());
            ...
            // - 순서가 중요, 일반적으로 가장 마지막 catch 절로 사용
